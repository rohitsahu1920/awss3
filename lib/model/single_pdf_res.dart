class SinglePDFModel {
  ...
  SinglePDFModel.fromJson(Map<String, dynamic> json)
...
class PostedData {
  final List<FileNameArray>? fileNameArray;
  ...
  PostedData.fromJson(Map<String, dynamic> json)
      : fileNameArray = (json['FileNameArray'] as List?)?.map((dynamic e) => FileNameArray.fromJson(e as Map<String,dynamic>)).toList();

  Map<String, dynamic> toJson() => {
    'FileNameArray' : fileNameArray?.map((e) => e.toJson()).toList()
  };
}
...
class FileNameArray {
  ...
  FileNameArray.fromJson(Map<String, dynamic> json)
